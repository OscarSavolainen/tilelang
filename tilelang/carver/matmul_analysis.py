...
def get_propagate_map(trans: bool = True, dtype="float16", matrix_name="A", index_dtype="int32"):
    ...
    assert dtype in [
        ...
        "e4m3_fnuz_float8",
        "e5m2_fnuz_float8",
    ], "Only support bfloat16, float16, int8, e4m3_float8, e5m2_float8, e4m3_fnuz_float8, e5m2_fnuz_float8"
    ...
    elif dtype in ["int8", "e4m3_float8", "e5m2_float8", "e4m3_fnuz_float8", "e5m2_fnuz_float8"]:
...
def get_ladder_stage3_map(dtype="float16", index_dtype="int32"):
    ...
    assert dtype in [
        ...
        "e4m3_fnuz_float8",
        "e5m2_fnuz_float8",
    ], "Only support float16, int8, e4m3_float8, e5m2_float8, e4m3_fnuz_float8, e5m2_fnuz_float8"
    if dtype in ["bfloat16", "float16"]:
